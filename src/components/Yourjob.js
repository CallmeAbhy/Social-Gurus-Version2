...
function Yourjob(props){
  ...
  // For Employee id
    ...
    useEffect(() => {
      axios.get(`http://34.205.65.36:4000/employee/find/?email=${mail}`)
      .then(response => {
...
Apply for Opportunity
        ...
        <Modal.Body>
          <Row>
            ...
            <Image
        src=
"https://media.istockphoto.com/id/1128262881/vector/decorative-black-gift-box-with-golden-bow-isolated-on-white.jpg?s=170667a&w=0&k=20&c=stGcjUB-jv3Sbpa9o1h5LnyodwZJB3EhhjvA6lhp9Zk="
        style={{width: "100%", }}
      />
            </Col>
            <Col xs={6}>
              <b>Oraganization</b> :- {props.Company}<br />
              <b>Job Profile</b> :-  {props.Profile}<br />
              <b>Openings</b>  :- {props.Slots}<br />          
        ...
        <Modal.Footer style={{backgroundColor: '#242424'}}>
          <Button variant="light" onClick={props.setOpen}>
            Close
          </Button>
          
          <Button  type="submit" onClick={applyjob}  style={{background: '#e1ad01', color: '#242424'}} >
            Apply
