...
console.log(fair);
  ...
  const fetchApiData = async (Id) => {
    try {
      const res = await fetch( `http://34.205.65.36:4000/client/postedJobs?id=${Id}`);
      console.log(res);
    ...
    <div>
                ...
                <div className="row text-center">
                  ...
                  <Container className="job-card mt-5 " id="read-more-wrap">
                    <Row >
                      ...
                      {
                          curElem.workfromhome === true ?   <Button variant="success" className="mt-3">Remote</Button>
                          :
                          <div>
                            {
      ...
      <ListGroup.Item>  ✅ {el.skill}</ListGroup.Item>
                    ...
                    <Row className="p-2">
                      ...
                      {open  && (element === index) && 
                      <Applicants_Modal   employeeid = { fair }  jobid = { job } open = { open } setOpen ={setOpen} />
                      }
                    ...
                    <Row className="mt-4">
                      ...
                      {
                        curElem.stipendtype === 'nominal' ? <p> Salary :- ₹ {curElem.stipendamountmin} to ₹ {curElem.stipendamountmax}</p>
                        :
                    ...
                    <Row>
                      <marquee>The Application is Vallid till <b class="blink">{date}</b> on <b class="blink">{result[0]}</b>  </marquee>
